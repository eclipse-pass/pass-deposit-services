 ...
 */
@Component
public class TerminalDepositStatusPolicy implements Policy<Deposit.DepositStatus> {

    private StatusEvaluator<Deposit.DepositStatus> statusEvaluator;

    @Autowired
    public TerminalDepositStatusPolicy(StatusEvaluator<Deposit.DepositStatus> statusEvaluator) {
