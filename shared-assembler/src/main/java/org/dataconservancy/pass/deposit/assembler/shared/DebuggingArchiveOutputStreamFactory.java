 ...
 */
public class DebuggingArchiveOutputStreamFactory extends DefaultArchiveOutputStreamFactory {

    public DebuggingArchiveOutputStreamFactory(Map<String, Object> packageOptions) {
